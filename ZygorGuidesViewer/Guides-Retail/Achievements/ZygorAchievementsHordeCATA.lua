...
Follow the path, clearing trash as you make your way to the first boss, Lord Marrowgar |goto Icecrown Citadel/1 39.0,52.4 < 20 |noway |c
step
...
|achieve 4534 |goto Icecrown Citadel/1 39.0,52.4
...
path loop off
path	38.9,29.2	38.9,36.3	39.0,52.4
Follow the path, clearing trash as you make your way to the first boss, Lord Marrowgar |goto Icecrown Citadel/1 39.0,52.4 <5 |noway |c
step
In order to not be impaled, you should be sure to get hit by it's Bone Slice ability
People who have been hit by that will not be able to be impaled |achieve 4610 |goto Icecrown Citadel/1 39.0,52.4
|tip Set the difficulty to Heroic to earn a portion of the Heroic: Storming the Citadel Achievement.
step
...
Follow the path, clearing trash as you make your way to the next boss, the Omnotron Defense System |goto Blackwing Descent/1 61.0,57.3 < 5 |noway |c
step
...
Beth'tilac's Lair |achieve 5829/4 |goto Firelands/1 29.1,62.3
Flamebreach |achieve 5829/1 |goto Firelands/1 34.1,75.1
The Ridge of Ancient Flame |achieve 5829/5 |goto Firelands/1 61.6,55.9
Shattershow |achieve 5829/3 |goto Firelands/1 61.2,45.4
Path of Corruuption |achieve 5829/2 |goto Firelands/1 34.0,30.8
...
Follow the path to Magmaw |goto Blackwing Descent/1 31.5,56.9 < 10 |noway |c
step
...
Location 1: |goto Borean Tundra 84.6,46.8
Location 2: |goto Borean Tundra 80.8,46.0
Location 3: |goto Borean Tundra 81.4,31.4
Location 4: |goto Borean Tundra 85.8,34.6
Location 5: |goto Borean Tundra 91.6,32.6
step
...
Location 1: |goto Dragonblight 70.8,30.2
Location 2: |goto Dragonblight 62.6,42.2
Location 3: |goto Dragonblight 59.0,60.2
Location 4: |goto Dragonblight 54.6,56.8
Location 5: |goto Dragonblight 61.0,31.0
step
...
Location 1: |goto Dragonblight 86.8,41.6
Location 2: |goto Dragonblight 72.0,74.0
step
...
Location 1: |goto Grizzly Hills 13.2,48.6
Location 2: |goto Grizzly Hills 22.4,73.2
Location 3: |goto Grizzly Hills 12.2,70.6
step
...
Locaiton 1: |goto Grizzly Hills 34.6,49.0
Location 2: |goto Grizzly Hills 28.6,45.8
step
...
Location 1: |goto Howling Fjord 53.0,11.4
Location 2: |goto Howling Fjord 60.8,20.2
Location 3: |goto Howling Fjord 68.6,17.6
Location 4: |goto Howling Fjord 71.6,13.8
step
...
Location 1: |goto Icecrown 32.0,69.6
Location 2: |goto Icecrown 60.8,20.2
Location 3: |goto Icecrown 72.8,38.8
step
...
Location 1: |goto Icecrown 31.8,41.8
Location 2: |goto Icecrown 58.2,54.2
step
...
Location 1: |goto Sholazar Basin 58.2,64.0
Location 2: |goto Sholazar Basin 52.6,72.2
Location 3: |goto Sholazar Basin 41.8,69.6
Location 4: |goto Sholazar Basin 41.0,58.6
Location 5: |goto Sholazar Basin 45.8,54.4
step
...
Location 1: |goto Sholazar Basin 59.0,80.8
Location 2: |goto Sholazar Basin 50.6,78.2
Location 3: |goto Sholazar Basin 27.6,45.2
Location 4: |goto Sholazar Basin 37.6,28.8
Location 5: |goto Sholazar Basin 49.8,45.0
step
...
Location 1: |goto Sholazar Basin 67.0,79.6
Location 1: |goto Sholazar Basin 51.0,81.6
Location 1: |goto Sholazar Basin 22.6,70.6
Location 1: |goto Sholazar Basin 31.0,66.6
Location 1: |goto Sholazar Basin 36.6,31.0
Location 1: |goto Sholazar Basin 59.4,22.6
step
...
Location 1: |goto The Storm Peaks 37.8,58.6
Location 2: |goto The Storm Peaks 41.0,51.6
Location 3: |goto The Storm Peaks 41.6,40.6
step
...
Location 1: |goto Zul'Drak 25.8,76.8
Location 2: |goto Zul'Drak 26.6,71.2
Location 3: |goto Zul'Drak 22.0,70.6
Location 4: |goto Zul'Drak 18.0,70.6
Location 5: |goto Zul'Drak 14.6,56.8
Location 6: |goto Zul'Drak 23.0,62.8
Location 7: |goto Zul'Drak 26.6,55.4
step
...
Location 1: |goto Zul'Drak 61.2,36.6
Location 2: |goto Zul'Drak 71.6,23.4
Location 3: |goto Zul'Drak 72.2,28.4
Location 4: |goto Zul'Drak 81.6,34.6
Location 5: |goto Zul'Drak 77.6,42.8
Location 6: |goto Zul'Drak 74.8,66.4
step
label "Hunter"
...
step
Ride the Mercenary Ship to Vashj'ir |q 25924/1 |goto Durotar 58.0,10.4
...
step
talk Erunak Stonespeaker##41618
home The Immortal Coil |goto Kelp'thar Forest 38.7,31.7 |q 25942
stickystart "succulentcrabmeat"
step
kill 8 Zin'jatar Raider##41781 |q 25942/1 |goto Kelp'thar Forest 40.9,30.7
step
...
collect 5 Orgrimmar Axe##56243 |q 25944/1 |goto Kelp'thar Forest 36.7,28.9
step
...
Subdue an Abyssal Seahorse |q 25371/2 |goto Kelp'thar Forest 45.0,46.9
step
talk Moanah Stormhoof##41248
...
step
Explore Beth'more Ridge |achieve 4825/16 |goto Shimmering Expanse/0 50.5,76.4
step
...
talk Razgar##43239
You will only be able to complete 1 of the following quests per day
turnin A Furious Catch##26588 |goto Orgrimmar 65.7,41.1
turnin A Golden Opportunity##26572 |goto Orgrimmar 65.7,41.1
turnin A Staggering Effort##26557 |goto Orgrimmar 65.7,41.1
turnin Clammy Hands##26543 |goto Orgrimmar 65.7,41.1
turnin No Dumping Allowed##26556 |goto Orgrimmar 65.7,41.1
step
talk The Rokk##24393
...
Cook a Spiritual Soup |q 11381/1 |goto Nagrand 25.9,59.5
|next "turnin"
step
label "stew"
...
collect 1 Giant Turtle Tongue##62781 |goto Kelp'thar Forest 52.6,45.0
step
kill Brinescale Serpent##39948+
collect 1 Snake Eye##62780 |goto Kelp'thar Forest 56.6,37.8
step
kill Sabreclaw Skitterer##40276
collect 1 Monstrous Claw##62779 |goto Kelp'thar Forest 58.6,39.6
step
kill Glittergill Grouper##40309+, Ravenous Thresher##40219+, Slickskin Eel##41002+
collect 1 Algaefin Rockfish##53071 |goto Kelp'thar Forest 56.8,53.0
collect 2 Deepsea Sagefish##53072 |goto Kelp'thar Forest 56.8,53.0
collect 1 Fathom Eel##53070 |goto Kelp'thar Forest 56.8,53.0
...
collect 2 Crocolisk Tail##62784 |goto Uldum 55.6,45.8
step
Fish at this spot
collect 2 Lavascale Catfish##53068 |goto Uldum 54.9,37.1
collect 2 Blackbelly Mudfish##53066 |goto Uldum 54.9,37.1
collect 3 Sharptooth##53062 |goto Uldum 54.9,37.1
step
Fish at this spot
...
collect 1 Mountain Trout##53063 |goto Mount Hyjal 60.3,23.9
step
...
step
talk Frenk##49547
buy 1 Refreshing Spring Water##159 |goto Twilight Highlands 73.5,51.0
step
...
collect 1 Highland Guppy##53064 |goto Twilight Highlands 57.8,36.7
step
...
You can _find more_ Clefthooves at the following location |goto Nagrand 45.5,72.7
only if haveq(11381)
step
_Make_ a Cooking Fire |cast Cooking Fire##818
...
'|goto The Cape of Stranglethorn/0 39.6,81.5 < 20 |c |noway |or
step
map The Cape of Stranglethorn/0
path follow smart; loop off; ants curved; dist 30
...
collect 40 Speckled Tastyfish##19807 |q 44765/1 |next "Turnin_Stranglethorn_Fishing_Extravaganza" |or
'|goto The Cape of Stranglethorn/0 64.9,39.2 < 20 |c |noway |next "Reset_Path" |or
step
...
step
_Leave_ the tunnel |goto Eastern Plaguelands 4.7,35.6 < 15 |walk
talk Gidwin Goldbraids##45428
...
More Banshee's Bells _can be found_ along the Thondroril River, around this area |goto Eastern Plaguelands 8.9,55.7
step
talk Fiona##45417
...
More Plaguehound Runts _can be found_ here |goto Eastern Plaguelands 12.4,70.0
step
talk Fiona##45417
...
step
_Enter_ the crypt |goto Eastern Plaguelands 24.2,78.3 < 15 |walk
...
step
_Enter_ the crypt |goto Eastern Plaguelands 77.2,50.8 < 5 |walk
...
You can also find Tivax the Breaker in another big hut |goto Dragonblight 24.0,39.5
step
...
accept Punting Season##29101 |goto Mount Hyjal 27.1,62.0  |or
accept Those Bears Up There##29161 |goto Mount Hyjal 27.1,62.0 |or
or
confirm
step
...
Help an Alpine Songbird Get Revenge on the Mean Old Fire Elementals |achieve 5868/1 |goto Mount Hyjal 13.4,44.6
only if haveq(29148)
step
...
Help an Alpine Tortolla Get Revenge on the Mean Old Fire Elementals |achieve 5868/3 |goto Mount Hyjal 23.6,60.1
only if haveq(29101)
step
...
Help a Hyjal Bear Cub Get Revenge on the Mean Old Fire Elementals |achieve 5868/2 |goto Mount Hyjal 14.3,33.0
only if haveq(29161)
step
...
Help an Angry Little Squirrel Get Revenge on the Mean Old Fire Elementals |achieve 5868/4 |goto Mount Hyjal 12.7,34.8
Earn the And the Meek Shall Inherit Kalimdor achievement! |achieve 5868 |goto Mount Hyjal 12.7,34.8
step
...
turnin A Personal Summons##28790 |goto Orgrimmar 50.5,38.4
accept The Eye of the Storm##28805 |goto Orgrimmar 50.5,38.4
step
clicknpc Waters of Farseeing##50088
Witness the Vision of the Farseer |q 28805/1 |goto Orgrimmar 50.8,37.8
step
talk Farseer Krogar##45244
turnin The Eye of the Storm##28805 |goto Orgrimmar 50.5,38.4
step
...
accept The Earth Rises##25460 |goto Mount Hyjal 64.0,22.6
step
talk Tholo Whitehoof##40278
accept Inciting the Elements##25370 |goto Mount Hyjal 64.0,22.5
step
kill 8 Scalding Rock Elemental##40229+ |q 25460/1 |goto Mount Hyjal 65.8,20.8
...
kill 4 Twilight Inciter##39926+ |q 25370/1 |goto Mount Hyjal 65.8,20.8
step
talk Tholo Whitehoof##40278
turnin Inciting the Elements##25370 |goto Mount Hyjal 64.0,22.5
accept Flames from Above##25574 |goto Mount Hyjal 64.0,22.5
step
talk Anren Shadowseeker##39925
turnin The Earth Rises##25460 |goto Mount Hyjal 64.0,22.6
step
Use Tholo's Horn to call for an emerald dragon |use Tholo's Horn##55122
Burn the Infiltrators' Encampment |q 25574/1 |goto Mount Hyjal 55.9,15.8
step
talk Tholo Whitehoof##40278
turnin Flames from Above##25574 |goto Mount Hyjal 64.0,22.5
step
...
accept The Flameseer's Staff##25472 |goto Mount Hyjal 47.7,35.5
step
kill 4 Twilight Flamecaller##38926+ |q 25319/1 |goto Mount Hyjal 47.8,29.4
kill 10 Twilight Vanquisher##38913+ |q 25319/2 |goto Mount Hyjal 47.8,29.4
click Charred Staff Fragment##202846
collect 8 Charred Staff Fragment##54461 |q 25472/1 |goto Mount Hyjal 47.8,29.4
step
talk Malfurion Stormrage##15362
...
kill 30 Unbound Flame Spirit |q 25323/1 |goto Mount Hyjal 44.7,33.2
You can find more Blazebound Revenants found here |goto Mount Hyjal 48.5,29.2
step
talk Malfurion Stormrage##15362
...
Weaken Baron Geddon 20 Times |q 25464/1 |goto Mount Hyjal 44.1,27.0
...
step
talk Windspeaker Tamila##39869
accept Emerald Allies##25430 |goto Mount Hyjal 47.7,35.5
step
talk Alysra##38917
turnin Emerald Allies##25430 |goto Mount Hyjal 48.4,19.0
accept The Captured Scout##25320 |goto Mount Hyjal 48.4,19.0
step
...
collect Twilight Overseer's Key##53139 |q 25321/1 |goto Mount Hyjal 44.4,20.7
step
talk Scout Larandia##40096
...
step
talk Alysra##38917
turnin Return to Alysra##25424 |goto Mount Hyjal 48.4,19.0
accept A Prisoner of Interest##25324 |goto Mount Hyjal 48.4,19.0
step
_Enter_ the cave |goto Mount Hyjal 52.6,17.3 < 10 |walk
...
step
_Leave_ the cave |goto Mount Hyjal 52.6,17.3 < 10 |walk
...
accept End of the Supply Line##25233 |goto Mount Hyjal 35.8,19.7
accept In the Rear With the Gear##25234 |goto Mount Hyjal 35.8,19.7
step
kill 6 Twilight Hunter##39437+ |q 25255/1 |goto Mount Hyjal 34.6,24.5
kill 4 Twilight Proveditor##39436+ |q 25233/1 |goto Mount Hyjal 34.6,24.5
...
step
talk Jadi Falaryn##39427
turnin End of the Supply Line##25233 |goto Mount Hyjal 35.8,19.7
turnin In the Rear With the Gear##25234 |goto Mount Hyjal 35.8,19.7
step
talk Oomla Whitehorn##39429
...
collect Bitterblossom##52727 |q 25297/2 |goto Mount Hyjal 28.9,32.1
step
click Stonebloom##202702
collect Stonebloom##52726 |q 25297/1 |goto Mount Hyjal 26.5,35.0
step
...
turnin From the Mouth of Madness##25297 |goto Mount Hyjal 28.4,36.5
accept Free Your Mind, the Rest Follows##25298 |goto Mount Hyjal 28.4,36.5
step
_Enter_ the cave |goto Mount Hyjal 26.9,36.3 < 10 |walk
...
turnin Mastering Puppets##25301 |goto Mount Hyjal 25.8,41.6
accept Elementary!##25303 |goto Mount Hyjal 25.8,41.6
step
...
Activate the Crucible of Earth |q 25303/1 |goto Mount Hyjal 25.6,41.7
step
...
step
click The Twilight Apocrypha##202712
turnin Elementary!##25303 |goto Mount Hyjal 25.8,41.6
accept Return to Duskwhisper##25312 |goto Mount Hyjal 25.8,41.6
step
label "miniongargol"
kill Hovel Brute##39642+, Hovel Shadowcaster##39643+
Slay 8 Minions of Gar'gol |q 25277/1 |goto Mount Hyjal 26.7,39.2
talk Twilight Servitor##39644
Administor the drought
Free 8 Twilight Servitors |q 25298/1 |goto Mount Hyjal 26.7,39.2
step
talk Kristoff Manheim##39797
turnin Gar'gol's Gotta Go##25328 |goto Mount Hyjal 27.2,40.8
accept Get Me Outta Here!##25332 |goto Mount Hyjal 27.2,40.8
step
Leave the cave |goto Mount Hyjal 27.1,36.0 < 10 |walk
Escort Kristoff Out |q 25332/1 |goto Mount Hyjal 27.1,36.0
step
talk Royce Duskwhisper##39435
...
step
talk Takrik Ragehowl##39432
turnin Cleaning House##25277 |goto Mount Hyjal 28.4,29.9
accept Sweeping the Shelf##25354 |goto Mount Hyjal 28.4,29.9
accept Lightning in a Bottle##25355 |goto Mount Hyjal 28.4,29.9
step
talk Rio Duran##39434
turnin Free Your Mind, the Rest Follows##25298 |goto Mount Hyjal 28.2,29.9
step
kill 8 Twilight Stormcaller##39843+ |q 25354/1 |goto Mount Hyjal 29.1,40.7
kill 5 Howling Riftdweller##39844+ |q 25354/2 |goto Mount Hyjal 29.1,40.7
click Lightning Channel##202743
collect Charged Condenser Jar##52834 |q 25355/1 |goto Mount Hyjal 29.1,40.7
step
...
step
Go inside the blue portal |goto Mount Hyjal 25.8,41.5 < 10 |walk
talk Jordan Olafson##40834
turnin Into the Maw!##25617 |goto Mount Hyjal 26.3,41.9
...
step
kill 12 Dark Iron Laborer##40838+ |q 25576/1 |goto Mount Hyjal 29.6,41.8
...
Destroy 8 Smoldering Cores |q 25577/1 |goto Mount Hyjal 29.6,41.8
click Twilight Arms Crate##9393+
Destroy 10 Twilight Arms Crates |q 25575/1 |goto Mount Hyjal 29.6,41.8
step
talk Yargra Blackscar##40837
...
kill Forgemaster Pyrendius##40845 |q 25600/1 |goto Mount Hyjal 31.9,46.3
step
talk Jordan Olafson##40834
turnin Forgemaster Pyrendius##25600 |goto Mount Hyjal 26.3,41.9
accept Return from the Firelands##25612 |goto Mount Hyjal 26.3,41.9
step
_Go inside_ the blue portal |goto Mount Hyjal 26.3,40.9 < 10 |walk
talk Takrik Ragehowl##39432
turnin Sweeping the Shelf##25354 |goto Mount Hyjal 28.4,29.9
turnin Return from the Firelands##25612 |goto Mount Hyjal 28.4,29.9
step
talk Vision of Ysera##46987
accept Aviana's Legacy##27874 |goto Mount Hyjal 28.4,29.8
step
talk Rio Duran##39434
...
collect 8 Bileberry##53102 |q 25408/1 |goto Mount Hyjal 21.1,42.6
step
talk Tyrus Blackhorn##39933
...
Subjugate a Twilight Inferno Lord |q 25411/1 |goto Mount Hyjal 14.5,45.3
step
Next to you:
...
step
label "ragingtwi"
kill 10 Raging Firestorm##39939+ |q 25381/1 |goto Mount Hyjal 11.3,38.2
kill 6 Twilight Inferno Lord##39974+ |q 25382/1 |goto Mount Hyjal 11.3,38.2
clicknpc Panicked Bunny##39997+, Terrified Squirrel##39998+
collect 10 Frightened Animal##53060 |q 25385/1 |goto Mount Hyjal 11.3,38.2
step
talk Laina Nightsky##39927
...
Lead the Injured Fawns back to Mylune at |goto Mount Hyjal 19.2,37.9
Escort 3 Injured Fawns Home |q 25392/1 |goto Mount Hyjal 12.5,44.6
step
talk Mylune##39930
...
accept Good News... and Bad News##29066 |goto Mount Hyjal 22.3,44.9
step
talk Laina Nightsky##39927
accept Last Stand at Whistling Grove##25940 |goto Mount Hyjal 19.0,40.9
step
talk Matoclaw##39928
turnin Good News... and Bad News##29066 |goto Mount Hyjal 19.0,37.0
step
talk Keeper Taldros##39932
turnin Last Stand at Whistling Grove##25940 |goto Mount Hyjal 13.7,32.8
accept The Bears Up There##25462 |goto Mount Hyjal 13.7,32.8
step
...
Rescue 6 Hyjal Bear Cubs |q 25462/1 |goto Mount Hyjal 13.9,34.1
step
talk Keeper Taldros##39932
turnin The Bears Up There##25462 |goto Mount Hyjal 13.7,32.8
accept Smashing Through Ashes##25490 |goto Mount Hyjal 13.7,32.8
step
kill 8 Charbringer##40336+ |q 25490/1 |goto Mount Hyjal 16.4,51.8
step
...
step
kill 10 Lava Surger##46911+ |q 25492/1 |goto Mount Hyjal 34.0,53.2
kill Core Hound##46910+
collect 4 Core Hound Entrails##54609 |q 25493/1 |goto Mount Hyjal 34.0,53.2
click Scorched Soil##202884
collect 10 Hyjal Seedling##54574 |q 25491/1 |goto Mount Hyjal 34.0,53.2
step
talk Thisalee Crow##41006
accept The Wormwing Problem##25655 |goto Mount Hyjal 42.2,45.4
accept Scrambling for Eggs##25656 |goto Mount Hyjal 42.2,45.4
step
talk Choluna##41005
...
Offer the Nectar |q 25663/1 |goto Mount Hyjal 40.4,44.3
talk Mysterious Winged Spirit##41068
turnin An Offering for Aviana##25663 |goto Mount Hyjal 40.4,44.3
accept A Plea From Beyond##25665 |goto Mount Hyjal 40.4,44.3
step
kill Wormwing Screecher##41027+, Wormwing Swifttalon##41028+
Slay 10 Wormwing Harpies |q 25655/1 |goto Mount Hyjal 36.9,43.4
click Stolen Hyjal Egg##203143
collect 8 Hyjal Egg##55189 |q 25656/1 |goto Mount Hyjal 36.9,43.4
step
talk Thisalee Crow##41006
turnin The Wormwing Problem##25655 |goto Mount Hyjal 42.2,45.4
turnin Scrambling for Eggs##25656 |goto Mount Hyjal 42.2,45.4
accept A Bird in Hand##25731 |goto Mount Hyjal 42.2,45.4
step
talk Choluna##41005
...
Fight Marion Wormwing until she gets captured |q 25731/1 |goto Mount Hyjal 38.4,44.2
talk Marion Wormwing##41112
Ask her why she is stealing eggs, then tell Thisalee to kill her
Interrogate Marion Wormwing |q 25731/2 |goto Mount Hyjal 38.4,44.2
step
...
kill Blaithe##41084
collect Ancient Feather##55210 |q 25664/1 |goto Mount Hyjal 39.2,37.1
step
talk Thisalee Crow##41006
turnin A Bird in Hand##25731 |goto Mount Hyjal 42.2,45.4
step
talk Choluna##41005
...
step
Go inside the blue portal |goto Mount Hyjal 38.8,58.0 < 10 |walk
talk Farden Talonshrike##40578
...
step
click Twilight Weapon Rack##130
collect Twilight Firelance##52716 |q 25523 |goto Mount Hyjal 37.2,56.2
step
...
You can find more Firelands Eggs around this area |goto Mount Hyjal 35.8,53.6
step
Use your Flap ability on your hotbar repeatedly to fly to this spot
talk Farden Talonshrike##40578
...
Earn the Death From Above achievement! |achieve 5874 |goto Molten Front 33.9,57.2
step
...
Slay Black Recluse |achieve 5482/6 |goto Twilight Highlands 45.8,31.6
step
kill Dillan MacHurley##46378
Slay Dillan MacHurley |achieve 5482/4 |goto Twilight Highlands 46.2,37.2
step
kill Gunwald Greybeard##46376
Slay Gunwald Greybeard |achieve 5482/1 |goto Twilight Highlands 45.2,42.8
step
kill Cliff Thundermar##46377
Slay Cliff Thundermar |achieve 5482/2 |goto Twilight Highlands 51.8,28.4
step
kill Korthalon##47171
Slay Korthalon |achieve 5482/5 |goto Twilight Highlands 52.0,27.6
...
Ask what he can tell you about the spiders |achieve 5870/7 |goto Molten Front 66.1,63.9
step
Earn the 'Fireside Chat' Achievement |achieve 5870 |next "gratz"
If you chose to do 'Into the Fire' first, click here to reset the guide for tomorrow |confirm |next "day_2"
step
...
Earn the Fungal Frenzy achievement! |achieve 5450 |goto Deepholm 74.0,41.2
step
...
_Wave at_ Linken |achieve 5865/1 |goto Mount Hyjal 30.7,75.9
_Wave at_ Hemet Nesingwary |achieve 5865/2 |goto Mount Hyjal 30.7,75.9
_Wave at_ Nat Pagle |achieve 5865/3 |goto Mount Hyjal 30.7,75.9
_Wave at_ Chromie |achieve 5865/4 |goto Mount Hyjal 30.7,75.9
_Wave at_ Mankrik |achieve 5865/5 |goto Mount Hyjal 30.7,75.9
_Wave at_ Thassarian |achieve 5865/6 |goto Mount Hyjal 30.7,75.9
step
...
step
clicknpc Confiscated Artillery##49499 |goto Uldum 42.0,5.0
...
Slay Millagazor without taking damage from Gout of Flame |achieve 5869/2 |goto Mount Hyjal 13.4,44.6
|tip When Millagazor starts casting Gout of Flame, move around so that you don't get hurt
step
kill Lylagar##52766
Slay Lylagar without taking damage from Lylagar Breath |achieve 5869/1 |goto Mount Hyjal 41.8,56.0
|tip When Lylagar starts casting Lylagar Breath, move around so that you don't get hurt.
step
kill Galenges##52399
Slay Galenges before he is weakened a second time |achieve 5869/4  |goto Mount Hyjal 41.7,56.1
|tip Get a group of people to help you kill Galenges really fast.
step
kill Nemesis##52383
Slay Nemesis at Ashen Lake without taking damage from Molten Fury |achieve 5869/5 |goto Mount Hyjal 24.1,55.7
...
Earn the My Very Own Broodmother achievement! |achieve 5447 |goto Deepholm 56.6,14.1
|only if rep("Therazane")>=Revered
step
...
step
Enter the cave |goto Deepholm 58.3,25.6 < 10 |walk
Follow this path |goto Deepholm 65.3,18.4 < 10 |only if walking
talk Pebble##49956
Tell him to follow you |goto Deepholm 63.1,20.8
...
Defeat Hurp'derp |q 27863/1 |goto Twilight Highlands 51.4,57.8 |only if haveq(27863) or completedq(27863)
Defeat Hurp'derp |q 27861/1 |goto Twilight Highlands 51.4,57.8 |only if haveq(27861) or completedq(27861)
Defeat Hurp'derp |q 27862/1 |goto Twilight Highlands 51.4,57.8 |only if haveq(27862) or completedq(27862)
step
...
Defeat Sully Kneecapper |q 27865/1 |goto Twilight Highlands 51.4,57.8
step
Click the _Quest Complete_ Box:
...
Defeat Cadaver Collage |q 27866/1 |goto Twilight Highlands 51.4,57.8
step
Click the _Quest Complete_ Box:
...
Defeat Lord Geoffery Tulvan |q 27867/1 |goto Twilight Highlands 51.4,57.8
step
Click the _Quest Complete_ Box:
...
Defeat Emberscar the Devourer |q 27868/1 |goto Twilight Highlands 51.4,57.8
step
Click the _Quest Complete_ Box:
...
accept The Carpenter##27758 |goto The Deadmines 43.7,82.7
step
kill Helix Gearbreaker |q 27758/1 |goto The Deadmines 49.7,90.2
...
collect 1 Dragon Flank##62782 |achieve 5753 |goto Twilight Highlands/0 65.2,79.0
step
