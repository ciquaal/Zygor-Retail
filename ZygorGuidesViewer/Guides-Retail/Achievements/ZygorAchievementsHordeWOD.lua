...
Tame a Riverwallow |q 36945/1 |goto Talador/0 64.4,56.3
step
#include "Garrison_Large_Building", action="talk Sage Paluna##87242", building="Stables"
|tip She walks around this area.
...
Tame a Meadowstomper |q 36946/1 |goto Nagrand D/0 85.1,40.7
step
#include "Garrison_Large_Building", action="talk Tormak the Scarred##86979", building="Stables"
|tip He walks around this area.
...
Tame a Snarler |q 36950/1 |goto Nagrand D/0 57.2,60.3
step
#include "Garrison_Large_Building", action="talk Sage Paluna##87242", building="Stables"
|tip She walks around this area.
...
Stonetooth slain |q 35154/1 |goto Frostwall/26 57.5,83.8
step
talk Gorsol##81688
...
Gorefu defeated |q 36469/2 |goto Frostwall/0 36.9,75.4
step
...
accept A Song of Frost and Fire##33815 |goto Frostfire Ridge/0 40.8,67.1
step
Follow the path |goto Frostfire Ridge/0 41.6,66.8 < 20 |only if walking
Get Introduced to Durotan |q 33815/1 |goto Frostfire Ridge/0 41.8,69.7
step
talk Durotan##78272
turnin A Song of Frost and Fire##33815 |goto Frostfire Ridge/0 41.8,69.7
accept Of Wolves and Warriors##34402 |goto Frostfire Ridge/0 41.8,69.7
step
Follow the path |goto Frostfire Ridge/0 42.9,69.0 < 20 |only if walking
Follow the path |goto Frostfire Ridge/0 44.7,68.9 < 20 |only if walking
talk Thrall##70859
turnin Of Wolves and Warriors##34402 |goto Frostfire Ridge/0 48.7,65.3
accept For the Horde!##34364 |goto Frostfire Ridge/0 48.7,65.3
step
...
Plant the Horde Banner |q 34364/1 |goto Frostfire Ridge/0 48.7,64.9
step
talk Gazlowe##78466
turnin For the Horde!##34364 |goto Frostfire Ridge/0 48.7,64.9
accept Back to Work##34375 |goto Frostfire Ridge/0 48.7,64.9
accept A Gronnling Problem##34592 |goto Frostfire Ridge/0 48.7,64.9
...
Mark #6# Trees For Peons |q 34375/1 |goto Frostfire Ridge/0 48.3,65.8
step
label "frostfiregronnlings"
kill 8 Frostfire Gronnling##79529 |q 34592/1 |goto Frostfire Ridge/0 48.3,65.8
step
talk Gazlowe##78466
turnin Back to Work##34375 |goto Frostfire Ridge/0 48.7,64.9
turnin A Gronnling Problem##34592 |goto Frostfire Ridge/0 48.7,64.9
accept The Den of Skog##34765 |goto Frostfire Ridge/0 48.8,64.9
step
Follow the path |goto Frostfire Ridge/0 48.8,66.8 < 20 |walk
kill Skog##79903 |q 34765/1 |goto Frostfire Ridge/0 48.5,70.1
step
talk Gazlowe##78466
turnin The Den of Skog##34765 |goto Frostfire Ridge/0 48.8,64.9
accept Establish Your Garrison##34378 |goto Frostfire Ridge/0 48.8,64.9
step
Use the Master Surveyor to Watch Your Garrison be Constructed |q 34378/1 |goto Frostfire Ridge/0 46.9,66.4
step
...
step
talk Rokhan##78487
accept The Ogron Live?##34823 |goto Frostwall/0 51.3,51.4
step
click Garrison Cache##237191
|tip It looks like a wooden crate bearing a Horde logo sitting next to a small pile of logs.
Investigate Your Garrison Cache |q 34824/2 |goto Frostwall/0 54.8,52.3
step
Go through the doorway |goto Frostwall/0 51.7,32.0 < 10 |walk
talk Senior Peon II##86775
Select _"Gazlowe needs you."_
Speak With Senior Peon II |q 34824/3 |goto Frostwall/0 49.4,16.4
step
Follow the path |goto Frostwall/0 41.6,31.4 < 20 |only if walking
talk Skaggit##80225
Select _"Get the peons back to work."_
Instruct Skaggit to Release the Peons |q 34824/1 |goto Frostwall/0 41.1,50.9
step
Go through the doorway |goto Frostwall/0 44.0,48.7 < 10 |walk
talk Gazlowe##78466
turnin What We Got##34824 |goto Frostwall/0 52.4,53.4
step
...
step
Enter the cave |goto Frostfire Ridge 40.2,60.1 < 20 |walk
Follow the path |goto Frostfire Ridge 40.4,58.8 < 10 |walk
kill Groog##80167 |q 34823/1 |goto Frostfire Ridge 41.9,59.0
step
talk Rokhan##78487
turnin The Ogron Live?##34823 |goto Frostfire Ridge 51.3,51.3
step
talk Gazlowe##78466
turnin What We Need##34822 |goto Frostfire Ridge 52.5,53.3
accept Build Your Barracks##34461 |goto Frostfire Ridge 52.5,53.3
step
click Garrison Blueprint: Barracks##231012
|tip It looks like a big white unrolled scroll sitting on a table.
Find Gazlowe's Missing Blueprints |q 34461/1 |goto Frostfire Ridge 59.8,50.0
step
...
Build Your Barracks |q 34461/3 |goto Frostwall/0 52.2,53.3
step
#include "Garrison_Finalize_Large", building="Barracks"
Finalize Your Plot |q 34461/5
step
talk Gazlowe##78466
turnin Build Your Barracks##34461 |goto Frostwall/0 57.4,48.4
accept We Need An Army##34861 |goto Frostwall/0 57.4,48.4
step
talk Warmaster Zog##79740
|tip He's inside the building.
turnin We Need An Army##34861 |goto Frostwall/0 53.9,55.0
accept Winds of Change##34462 |goto Frostwall/0 53.9,55.0
step
Follow the path |goto Frostfire Ridge/0 54.1,64.8 < 20 |only if walking
Follow the path |goto Frostfire Ridge/0 56.1,62.4 < 10 |only if walking
Enter the cave |goto Frostfire Ridge/0 56.6,62.5 < 10 |walk
clicknpc Olin Umberhide##80577
|tip He is hanging upside down in the cave.
Rescue Olin Umberhide |q 34462/1 |goto Frostfire Ridge/0 57.3,62.9
step
Leave the cave |goto Frostfire Ridge/0 56.7,62.6 < 10 |walk
Follow the path |goto Frostfire Ridge/0 53.2,63.4 < 20 |only if walking
Follow the path |goto Frostfire Ridge/0 49.9,60.5 < 20 |only if walking
Enter the Garrison |goto Frostwall/0 51.7,32.3 < 20 |walk
talk Warmaster Zog##79740
turnin Winds of Change##34462 |goto Frostwall/0 53.9,54.9
accept Mission Probable##34775 |goto Frostwall/0 53.9,54.9
step
...
Use the Command Table to Send Olin Umberhide on a Mission |q 34775/1 |goto Frostwall/0 53.7,54.4
step
talk Warmaster Zog##79740
turnin Mission Probable##34775 |goto Frostwall/0 53.9,54.9
step
talk Farseer Drek'Thar##76411
accept Den of Wolves##34379 |goto Frostwall/0 49.7,49.7
step
clicknpc Frostwolf Rylak##78320
|tip It looks like a winged creature with 2 heads.
Ride the Frostwolf Rylak to Wor'gol |q 34379/1 |goto Frostwall/0 46.9,49.8 < 5
step
talk Pul Windcarver##76782
fpath Wor'gol |goto Frostfire Ridge/0 21.6,56.1
step
talk Durotan##70860
turnin Den of Wolves##34379 |goto Frostfire Ridge/0 20.7,58.0
accept Rally the Frostwolves##34380 |goto Frostfire Ridge/0 20.7,58.0
step
talk Farseer Drek'Thar##80456
|tip You may have to wait for him to run here.
accept Honor Has Its Rewards##33816 |goto Frostfire Ridge/0 21.0,57.9
step
Follow the path |goto Frostfire Ridge/0 20.5,56.9 < 25 |only if walking
Follow the path |goto Frostfire Ridge/0 19.4,57.6 < 25 |only if walking
...
Receive the Blessing From the Shamanstone |q 33816/1 |goto Frostfire Ridge/0 17.5,56.7
step
talk Farseer Drek'Thar##76616
turnin Honor Has Its Rewards##33816 |goto Frostfire Ridge/0 17.68,56.70
step
Follow the path |goto Frostfire Ridge/0 19.7,60.2 < 20 |only if walking
talk Draka##78971
Ask Draka to Sound the War Horn |q 34380/1 |goto Frostfire Ridge/0 19.4,60.1
step
talk Durotan##76557
turnin Rally the Frostwolves##34380 |goto Frostfire Ridge/0 20.9,57.9
accept Gormaul Tower##33784 |goto Frostfire Ridge/0 20.9,57.9
step
Follow the path |goto Frostfire Ridge/0 21.6,58.0 < 20 |only if walking
Go through the gate |goto Frostfire Ridge/0 23.5,56.2 < 20 |only if walking
Follow the path |goto Frostfire Ridge/0 23.9,52.3 < 20 |only if walking
Follow the path |goto Frostfire Ridge/0 24.1,48.3 < 20 |only if walking
Follow the path |goto Frostfire Ridge/0 22.6,46.0 < 20 |only if walking
Meet Durotan at Gormaul Tower |q 33784/1 |goto Frostfire Ridge/0 21.3,44.1
step
...
step
kill Razortusk the Untamed##76208 |q 33784/5 |goto Frostfire Ridge/0 19.5,44.4
|tip He is a giant boar that will appear once you've cleared the area of enemies.
step
talk Durotan##76240
turnin Gormaul Tower##33784 |goto Frostfire Ridge/0 19.7,44.8
accept These Colors Don't Run##33526 |goto Frostfire Ridge/0 19.7,44.8
step
Follow the path |goto Frostfire Ridge/0 20.9,41.8 < 20 |walk
...
step
Go through the doorway |goto Frostfire Ridge/1 31.9,48.1 < 20 |walk
talk Durotan##75177
...
collect 5 Frostwolf Oil##107361 |q 33546/1 |goto Frostfire Ridge/1 40.6,53.4 < 20
step
Enter the doorway |goto Frostfire Ridge/1 53.1,49.4 < 10 |walk
talk Gol'kosh the Axe##75167
Take the Oil to Gol'kosh |q 33546/2 |goto Frostfire Ridge/1 56.0,43.8
step
Go through the doorway |goto Frostfire Ridge/1 52.8,49.4 < 10 |walk
Leave the building |goto Frostfire Ridge/1 38.0,44.1 < 20 |walk
Follow the path |goto Frostfire Ridge/1 29.3,61.4 < 20 |only if walking
talk Durotan##75177
...
step
Follow the path |goto Frostfire Ridge/1 34.2,76.6 < 15 |only if walking
...
step
Leave the building |goto Frostfire Ridge/2 67.4,79.9 < 10 |walk
...
step
Leave the building |goto Frostfire Ridge/2 67.4,79.9 < 10 |walk
Enter the building |goto Frostfire Ridge/2 63.5,65.0 < 20 |walk
Follow the path |goto Frostfire Ridge/2 59.4,45.4 < 20 |walk
...
Climb the Chain |q 33527/1 |goto Frostfire Ridge/2 50.1,31.8
step
...
kill Beastmaster Trokar##74708 |q 33468/3 |goto Frostfire Ridge/0 19.8,61.4
step
label "thunderlords"
kill Thunderlord Ranger##76289+, Thunderlord Invader##74329+, Thunderlord Handler##74514+, Thunderlord Seer##78073+
Slay #15# Thunderlords |q 33468/5 |goto Frostfire Ridge/0 20.0,59.0
step
label "free"
click Wor'gol Villager##84781+, Frost Wolf##74544+
Free #6# Villagers and Frostwolves |q 33807/1 |goto Frostfire Ridge/0 20.0,59.0
step
talk Draka##74651
turnin Save Wolf Home##33468 |goto Frostfire Ridge/0 20.8,57.9
turnin Free Our Brothers and Sisters##33807 |goto Frostfire Ridge/0 20.8,57.9
accept The Farseer##33469 |goto Frostfire Ridge/0 20.8,57.9
step
Follow the path |goto Frostfire Ridge/0 18.3,56.0 < 20 |walk
kill Warleader Gargrak##74653 |q 33469/1 |goto Frostfire Ridge/0 16.8,57.6
step
talk Farseer Drek'Thar##74272
turnin The Farseer##33469 |goto Frostfire Ridge/0 16.8,57.8
accept Pool of Visions##33470 |goto Frostfire Ridge/0 16.8,57.8
step
talk Farseer Drek'Thar##74272
Select _"I am ready for the ritual, farseer."_
Witness the Ritual of Vision |q 33470/1 |goto Frostfire Ridge/0 16.8,57.8
step
talk Farseer Drek'Thar##74272
turnin Pool of Visions##33470 |goto Frostfire Ridge/0 16.8,57.8
accept Back to Bladespire Citadel##33473 |goto Frostfire Ridge/0 16.8,57.8
step
Leave the cave |goto Frostfire Ridge/0 18.3,56.1 < 20 |walk
talk Pul Windcarver##76782
Select _"Pul, I need to quickly return to Bladespire Citadel."_
Fly Back to Bladespire Citadel |q 33473/1 |goto Frostfire Ridge/0 21.6,56.1
step
...
step
Leave the building |goto Frostfire Ridge/1 35.5,45.6 < 20 |walk
Follow the path |goto Frostfire Ridge/1 20.8,36.8 < 20 |only if walking
Follow the path |goto Frostfire Ridge/1 15.6,32.6 < 15 |only if walking
Follow the path |goto Frostfire Ridge/0 25.7,29.5 < 20 |only if walking
talk Ga'nar##70909
turnin Ga'nar's Vengeance##32783 |goto Frostfire Ridge/0 30.9,25.8
accept Let the Hunt Begin!##32791 |goto Frostfire Ridge/0 30.9,25.8
step
talk Ga'nar##70878
Select _"I am ready!"_
Tell Ga'nar You Are Ready |q 32791/1 |goto Frostfire Ridge/0 30.9,25.8
step
Watch the dialogue
...
step
Follow the path |goto Frostfire Ridge/0 39.5,29.4 < 20 |only if walking
Follow the path |goto Frostfire Ridge/0 41.8,32.2 < 20 |walk
click Thunderlord Supplies##220578
|tip The barrels and supplies are stacked against the wall.
Destroy the Thunderlord Supplies |q 32792/3 |goto Frostfire Ridge/0 42.3,34.3
step
label "thunderorcs"
...
step
Follow the path |goto Frostfire Ridge/0 42.3,30.4 |only if walking
Follow the path |goto Frostfire Ridge/0 43.8,31.3 |only if walking
talk Kal'gor the Honorable##74223
turnin They Rely on Numbers##32929 |goto Frostfire Ridge/0 46.4,32.0
step
talk Ga'nar##70910
...
Release #3# Captive Gronns |q 32794/1 |goto Frostfire Ridge/0 47.6,33.8
...
talk Ga'nar##70941
turnin Wrath of Gronn##32794 |goto Frostfire Ridge/8 50.6,54.4
accept The Eldest##32795 |goto Frostfire Ridge/8 50.6,54.4
step
talk Ga'nar##70941
...
step
Follow the path |goto Gorgrond/0 56.3,8.2 < 20 |only if walking
Follow the path |goto Gorgrond/0 56.8,10.3 < 30 |only if walking
Follow the path |goto Gorgrond/0 56.7,11.5 < 20 |only if walking
...
step
Follow the path |goto Gorgrond/0 56.9,14.1 < 30 |only if walking
...
Disrupt the Iron Horde Evacuation |q 38569/1 |goto Gorgrond/0 52.3,11.0
...
step
talk Gazlowe##78466
accept My Very Own Fortress##36614 |goto Frostwall/0 42.1,55.5
step
...
_Activate_ the Soul Transporter |goto Auchindoun/1 58.7,18.9 |c |noway
step
...
_Climb up_ the rock formation |goto Frostfire Ridge/0 15.2,50.8 < 15 |only if walking
...
_Go up_ the ramp |goto Frostfire Ridge/0 24.2,28.8 < 10 |walk
...
_Pass through_ the doorway |goto Frostfire Ridge/0 23.3,24.3 < 15 |only if walking
...
_Go down_ the ramp |goto Frostfire Ridge/0 22.6,9.4 < 20 |only if walking
...
_Continue up_ the small ramp |goto Frostfire Ridge/0 39.0,38.3 < 20 |only if walking
...
_Cross_ the field |goto Frostfire Ridge/0 44.4,41.9 < 25 |only if walking
_Follow_ the hidden path up |goto Frostfire Ridge/0 43.4,37.1 < 25 |only if walking
_Jump down_ the ledge here |goto Frostfire Ridge/0 42.3,32.7 < 20 |only if walking
...
_Jump down_ |goto Frostfire Ridge/0 46.5,32.5 < 25 |only if walking
...
_Continue_ along the path |goto Frostfire Ridge/0 58.3,28.3 < 45 |only if walking
...
_Continue_ around the path |goto Frostfire Ridge/0 66.2,80.3 < 25 |walk
...
_Follow_ the path down |goto Gorgrond/0 44.5,82.6 < 35 |only if walking
...
_Continue along_ the path |goto Gorgrond/0 52.9,80.6 < 35 |walk
...
_Jump down_ the ledge here |goto Gorgrond/0 40.8,68.0 < 25 |only if walking
_Follow_ the ramp up |goto Gorgrond/0 39.2,65.7 < 25 |only if walking
_Go up_ the ramp inside of the tower |goto Gorgrond/0 39.1,68.5 < 25 |only if walking
...
_Head up_ the small ramp |goto Gorgrond/0 59.5,53.7 < 25 |only if walking
_Cross_ the bridge |goto Gorgrond/0 58.0,54.5 < 25 |only if walking
...
_Continue_ along the path |goto Gorgrond/0 42.2,51.6 < 25 |only if walking
click Brokor's Sack##235859 |q 36506 |future |goto Gorgrond/0 41.73,52.97
|tip It's a small sack by the stones.
step
_Enter_ the cave |goto Gorgrond/0 43.5,48 < 25 |walk
...
_Go up_ the ramp |goto Talador/0 78.0,18.7 < 20 |walk
_Follow_ the path |goto Talador/0 79.8,17.4 < 20 |walk
...
_Go up_ the hill |goto Talador/0 69.0,15.9 < 35 |only if walking
...
_Continue_ along the mountain side |goto Talador/0 59.0,5.6 < 25 |only if walking
_Go up_ the hill |goto Talador/0 56.8,6.0 < 30 |only if walking
...
_Go down_ the ramp |goto Talador/0 52.1,33.4 < 25 |only if walking
click Luminous Shell##227954 |q 34235 |future |goto Talador 52.56,29.54
|tip It's a tiny sea shell on the ground.
step
_Enter_ the cave |goto Talador 53.3,26.2 < 15 |walk
...
_Leave_ the cave |goto Talador/0 78.3,35.5 < 15 |walk
...
_Cross_ the bridge |goto Talador/0 75.4,40.6 < 25 |only if walking
...
_Cross_ the platform |goto Talador/0 64.4,57.1 < 30 |only if walking
...
_Continue up_ the stairs |goto Talador/0 67.5,78.7 < 35 |only if walking
...
_Continue_ down the water fall |goto Talador/0 64.1,77.2 < 10
...
_Jump down the ledge_ |goto Talador/0 56.3,83.9 < 30 |only if walking
...
_Jump_ down the ledge |goto Talador/0 42.8,92.1 < 30 |only if walking
_Go down_ the path |goto Talador/0 39.0,93.6 < 30 |only if walking
talk Aarko##77664
...
_Make your way_ up the side of the mountain |goto Talador/0 37.2,89.3 < 30 |only if walking
...
_Enter_ the building |goto Talador/0 33.6,76.3 < 15 |walk
...
_Enter_ the cave |goto Talador/0 28.0,75.3 < 15 |walk
...
_Go up_ the hill |goto Talador/0 27.7,68.4 < 30 |only if walking
...
_Go up_ the hidden ramp |goto Spires of Arak/0 36.2,17.9 < 10 |walk
...
step
_Go down_ the narrow path |goto Spires of Arak 42.3,19.5 < 35 |only if walking
...
_Follow_ the path back |goto Spires of Arak 38.0,46.7 |only if walking
...
_Continue_ along the hidden path |goto Spires of Arak 40.7,56.8 < 25 |only if walking
...
_Jump down_ the ledge |goto Spires of Arak 51.9,61.3 < 25 |only if walking
...
_Continue_ along the path |goto Spires of Arak 52.9,76.2 < 30 |only if walking
...
_Go up_ the stairs |goto Spires of Arak 55.4,90.9 < 10 |walk
...
step
_Follow_ the path |goto Spires of Arak 60.0,73.6 < 35 |only if walking
...
_Go up_ the hidden ramp |goto Spires of Arak/0 63.1,66.3 < 15 |only if walking
...
_Follow_ the path |goto Spires of Arak 68.4,46.7 < 25 |only if walking
...
_Go up_ the hill |goto Spires of Arak 50.4,26.5 < 15 |only if walking
_Follow_ the path up |goto Spires of Arak 50.7,26.1 < 15 |only if walking
...
_Follow_ the path down |goto Spires of Arak 53.4,23.2 < 15 |only if walking
...
_Go up_ the ramp to Gul'var |goto Shadowmoon Valley D/0 23.0,29.2 < 35 |only if walking
...
_Continue down_ the hill |goto Shadowmoon Valley D/0 25.5,29.1 < 25 |only if walking
...
_Follow the mountainside trail_ |goto Shadowmoon Valley D/0 34.0,44.2 < 15 |only if walking
...
_Enter_ the room |goto Shadowmoon Valley D/0 33.5,40.1 < 15 |walk
...
_Enter_ the room |goto Shadowmoon Valley D/0 33.6,42.8 < 15 |walk
...
_Pass through_ |goto Shadowmoon Valley D/0 35.0,42.2 < 15 |only if walking
...
_Follow_ the narrow path |goto Shadowmoon Valley D/0 49.3,48.3 < 15 |only if walking
_Go up_ the rock formation |goto Shadowmoon Valley D/0 48.5,46.5 < 15 |only if walking
...
_Use_ the rocks to reach to top platform back in this corner |goto Shadowmoon Valley D/0 48.9,47.6 < 15 |walk
...
_Make your way_ to the open field |goto Shadowmoon Valley D/0 58.2,33.1 < 35 |only if walking
...
_Take_ the path towards Nagrand |goto Talador/0 31.0,58.8 < 20 |only if walking
...
_Go up_ the hill |goto Nagrand D/0 82.0,68.8 < 25 |only if walking
_Follow_ the narrow path here |goto Nagrand D/0 85.2,70.2 < 15 |only if walking
...
Collect the Trophy Ring of Gordal |goto Nagrand D 80.9,79.8
confirm
step
...
Once on the Glider, fly to this location  |goto Nagrand D 76.1,70.0 |only if walking
click Warsong Spear##233113
|tip It's a spear hanging from the rock ledge.
Collect the Ceremonial Warsong Spear |goto Nagrand D 76.1,70.0
confirm
step
_Make your way_ around the mountain |goto Nagrand D 78.3,68.5 < 15 |only if walking
_Go up_ the hill |goto Nagrand D 77.7,72.3 < 10 |only if walking
click Steamwheedle Exploration Glider##232567 |goto Nagrand D 76.1,73.0 < 10 |only if walking
...
step
_Make your way_ around the mountain |goto Nagrand D 78.3,68.5 < 15 |only if walking
_Go up_ the hill |goto Nagrand D 77.7,72.3 < 15 |only if walking
click Steamwheedle Exploration Glider##232567 |goto Nagrand D 76.1,73.0 < 10 |only if walking
...
_Make you way_ down the ledge |goto Nagrand D 72.0,71.6 |only if walking
_Jump_ down the ledge here  |goto Nagrand D 72.0,69.5|only if walking
_Make your way_ around the mountain |goto Nagrand D 78.3,68.5 < 15 |only if walking
_Go up_ the hill |goto Nagrand D 77.7,72.3 < 15 |only if walking
_Go up_ the ledge here |goto Nagrand D 75.9,65.9 < 15 |only if walking
_Carefully_ drop down the ledge here |goto Nagrand D 75.0,65.8 < 10 |only if walking
...
_Jump down_ the ledge here |goto Nagrand D 76.3,64.9 < 10 |only if walking
_Follow_ the path up to the Glider |goto Nagrand D 75.7,66.1 < 10 |only if walking
...
_Continue down_ the path |goto Nagrand D 68.1,52.7 < 30 |only if walking
...
_Continue down_ the ledge |goto Nagrand D/0 57.6,62.3 < 20 |only if walking
...
_Go up_ the stairs |goto Nagrand D/12 50.4,32.0 < 10 |only if walking
_Traverse_ the tunnel |goto Nagrand D/12 36.6,49.9 < 10 |only if walking
...
_Jump_ behind the tree |goto Nagrand D/0 62.1,66.8 < 30 |only if walking
...
_Enter_ Telaar |goto Nagrand D/0 68.2,64.2 < 35 |only if walking
...
_Enter_ Telaar |goto Nagrand D/0 68.4,64.3 < 25 |only if walking
...
step
_Enter_ the cave |goto Nagrand D 41.6,68.3 |walk
...
_Follow_ the path back |goto Nagrand D/0 41.8,53.1 < 20 |only if walking
...
accept Bonus Objective: The Howling Crag##36590 |goto Spires of Arak 61.5,25.1
...
_Enter_ the cave |goto Spires of Arak 64.8,24.1 < 20 |walk
...
kill Stored Projection##85887 |q 36590/6 |goto Spires of Arak/0 64.0,27.6
step
accept Bonus Objective: The Howling Crag##36590
_Follow_ the path in the cave |goto Spires of Arak 63.8,25.8 < 10 |walk
...
_Enter_ the cave |goto Spires of Arak/0 65.2,27.0 < 20 |walk
...
stickystart "2"
step
_Enter_ the cave |goto Frostfire Ridge/0 65.7,18.1 |walk
kill Maggle##78896 |q 34501/1
step
_Follow the path back |goto Frostfire Ridge/9 40.2,41.9 |walk
_Jump down_ the ledge |goto Frostfire Ridge/9 51.1,48.8 |walk
...
_Cross the bridge_ |goto Talador/0 42.7,40.4 < 20 |n |only if walking
_Take_ the elevator up |goto Talador/0 35.9,45.5 < 5 |c |only if walking
...
_Continue_ along the stone path |goto Talador 46.3,68.1 < 20 |only if walking
_Follow_ the stairs up |goto Talador 47.6,63.8 < 20 |only if walking
...
Enter the large circular building |goto Frostfire Ridge 49.5,21.3 < 10 |only if walking
Go up the wooden walkway  |goto Frostfire Ridge 49.4,22.0 < 5 |only if walking
