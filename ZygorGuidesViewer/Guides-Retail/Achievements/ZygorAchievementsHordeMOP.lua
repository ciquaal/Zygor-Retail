...
Blackguard's Jetsam |achieve 8727/2 |goto Timeless Isle 17.2,57.3 |n
step
...
step
kill 10 Jungle Serpent |q 29221/1 |goto Northern Stranglethorn 61.2,39.8
...
step
goto Northern Stranglethorn 76.5,67.5 |n
Enter the cave |goto Northern Stranglethorn 76.5,67.5,0.5 |noway |c
step
...
|confirm
step
talk Zafod Boombox##37184 |goto Icecrown Citadel/2 74.7,61.9
Tell him to give you a jetpack!
Equip the jetpack |use Goblin Rocket Pack##49278
|confirm
step
talk High Overlord Saurfang##36939 |goto Icecrown Citadel/2 73.3,61.4
...
Sonic Relay activated |q 31009/1 |goto Dread Wastes 40.0,39.0
|only if not completedq(31010)
step
...
Use the Ruining Fork on Iyyokuk the Lucid |q 31085/1 |goto Dread Wastes 32.4,33.7
...
|only if not completedq(31179)
step
Leave the cave |goto Dread Wastes 25.7,53.9 < 5 |c
|only if not completedq(31179)
step
...
talk Xaril the Poisoned Mind##62151
Tell him:
<I am ready to fly, Xaril.> |invehicle |q 31211 |goto Dread Wastes 28.6,42.1
|only if not completedq(31211)
step
...
Defeat 10 Shado-Pan Trainees within 10 seconds |achieve 7320 |goto Vale of Eternal Blossoms 19.7,74.2
...
|confirm
step
Enter the first temple here. |goto Kun-Lai Summit 69.6,53.0 |only if walking
Enter the second temple here. |goto Kun-Lai Summit 66.9,51.2 |only if walking
...
step
goto Isle of Thunder Scenario 54.1,46.2
...
Kill 200 Mantid |q 31808/2 |goto Dread Wastes 50.8,41.3
|only if haveq(31808)
step
talk Kaz'tik the Manipulator##63758
