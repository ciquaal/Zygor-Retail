...
Click Fort Livingston Adventurers |goto Northern Stranglethorn 52.0,61.4
...
Watch the dialogue |goto Northern Stranglethorn 52.9,66.5
...
|only if not completedq(31010)
step
Use the Ruining Fork in your bags |use Ruining Fork##84771 |goto Dread Wastes 32.4,33.7
...
step
Fight off the waves of Muckscale. |goto Dread Wastes 25.7,50.3
kill 12 Muckscale Flesheater##63465+ |q 31179/1
kill Muckscale Serpentus##63466 |q 31179/2
|only if not completedq(31179)
step
Leave the cave |goto Dread Wastes 25.7,53.9 <5 |c |q 31179
step
