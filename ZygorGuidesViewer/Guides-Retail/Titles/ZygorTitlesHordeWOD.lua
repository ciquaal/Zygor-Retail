...
_Continue_ up |goto Nagrand D/0 85.0,34.8 < 10 |only if walking
_Take the left_ path |goto Nagrand D/0 86.4,37.0 < 10 |only if walking
_Go down_ the path |goto Nagrand D/0 88.6,35.0 < 10 |only if walking
Head _along the side of the mountain_ |goto Nagrand D/0 89.0,30.3 < 10 |only if walking
