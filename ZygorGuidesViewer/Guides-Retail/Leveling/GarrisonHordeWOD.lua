...
Cross the bridge |goto Nagrand D/0 66.6,17.6 < 30 |only if walking
use Riverwallow-In-Training Whistle##118350
...
Continue up |goto Nagrand D/0 85.0,34.8 < 30 |only if walking
Take the left path |goto Nagrand D/0 86.4,37.0 < 20 |only if walking
Go down the path |goto Nagrand D/0 88.6,35.0 < 20 |only if walking
Head along the side of the mountain |goto Nagrand D/0 89.0,30.3 < 20 |only if walking
use Riverwallow-In-Training Whistle##118350
...
Heal your Battle Pets |q 31589/1 |goto Orgrimmar/1 62.1,35.3
step
talk Varzok##63626
...
Defeat Gorefu |q 36469/2 |goto Frostwall/0 36.9,75.4
step
...
kill Groog##80167 |q 34823/1 |goto Frostfire Ridge/0 41.9,59.0
|tip Inside the cave.
step
...
turnin A Rediscovered Legend##34697 |goto Gorgrond/0 42.8,63.1
step
...
step
talk Dusk-Seer Irizzar##83463
accept Not Here, Not Now##37328 |goto Spires of Arak/0 43.8,48.8
step
talk Taskmaster Gornek##81920
turnin Not Here, Not Now##37328 |goto Spires of Arak/0 40.2,43.4
step
...
step
talk Zooti Fizzlefury##86949
accept Temporal Juxtaposition##34472 |goto Talador/0 85.0,31.1
step
...
accept The Voice of Iyu##35402 |goto Gorgrond/0 46.6,71.5
talk Penny Clobberbottom##85831 |goto Gorgrond/0 46.2,69.7
|tip Talk to Penny at the location above to change your Outpost if needed.
_Or_
Click to Purchase this Follower with Gold |confirm |next "buy"
...
kill Voice of Iyu##81634 |q 35402/1 |goto Gorgrond/0 49.5,71.7
step
...
turnin The Voice of Iyu##35402 |goto Gorgrond/0 46.6,71.5
turnin Super Seeds##35406 |goto Gorgrond/0 46.6,71.5
step
talk Kaz the Shrieker##74606
accept Cutter##35430 |goto Gorgrond/0 46.6,71.5
step
Leave Beastwatch |goto Gorgrond 45.7,70.5 < 20 |walk
Run along the stone path |goto Gorgrond 45.4,74.6 < 20 |only if walking
Follow the path into the opening |goto Gorgrond/0 44.0,79.6 < 20 |only if walking
Go up the hill |goto Gorgrond/0 43.5,82.7 < 20 |only if walking
talk Cutter##82254
turnin Cutter##35430 |goto Gorgrond/0 43.7,84.0
accept A Green Ogron?##36482 |goto Gorgrond/0 43.7,84.0
...
turnin Secrets of the Botani##35536 |goto Gorgrond/0 42.1,85.9
...
talk Kaz the Shrieker##82228
turnin The Life Spring##35434 |goto Gorgrond/0 42.1,85.9
step
talk Kaz the Shrieker##82228
...
Reach Dreadtalon Peak |goto Spires of Arak/0 56.0,66.2 < 10 |only if walking
Continue up the path |goto Spires of Arak/0 55.5,65.4 < 10 |only if walking
Enter the cave |goto Spires of Arak/0 55.0,65.3 < 10 |walk
talk Leorajh##86887
...
click Astral Ward##230960
Destroy the Astral Ward |q 34889/1 |count 3 |goto Talador/0 69.0,82.0
step
...
Cross the bridge |goto Talador/0 73.2,26.7 < 20 |only if walking
...
Follow the path |goto Talador/0 63.4,61.8 < 20 |only if walking
...
kill Vizier Zulmork##80292 |q 34855/2 |goto Talador 67.1,77.0
|tip He's inside the stone building.
step
...
Free #5# Frostwolf Slaves |q 33119/1 |goto Frostfire Ridge/1 26.8,41.3
step
Go up the hill |goto Frostfire Ridge 28.8,42.2 < 20 |only if walking
Find Mulverick |q 33119/2 |goto Frostfire Ridge 30.8,41.5
step
...
Continue through the path |goto Frostfire Ridge/4 37.2,30.3 < 20 |only if walking
...
Continue down the path |goto Gorgrond 59.6,57.2 < 20 |only if walking
Make your way through the Crimson Fen |goto Gorgrond 58.4,62.7 < 20 |only if walking
Continue along the path |goto Gorgrond 56.1,63.4 < 20 |only if walking
Climb up the hill |goto Gorgrond 54.3,67.7 < 20 |only if walking
Go up the hill |goto Gorgrond 55.5,71.1 < 20 |only if walking
...
accept Chapter II: The Harvest##35527 |goto Gorgrond/0 57.1,71.9
accept Chapter III: Ritual of the Charred##35524 |goto Gorgrond/0 57.1,71.9
...
step
talk Shadow Hunter Rala##78208
accept Lurkers##34344 |goto Frostfire Ridge/0 52.6,40.4
accept Poulticide##34345 |goto Frostfire Ridge/0 52.6,40.4
stickystart "new1"
stickystart "new2"
step
click Frostblossom+
...
Click here to find more around this area |goto Frostfire Ridge/0 54.7,39.4
step
label "new1"
kill Ice Fury##78214+
...
step
talk Shadow Hunter Rala##78208
turnin Lurkers##34344 |goto Frostfire Ridge/0 52.6,40.4
turnin Poulticide##34345 |goto Frostfire Ridge/0 52.6,40.4
accept The Real Prey##34348 |goto Frostfire Ridge/0 52.6,40.4
step
...
accept Oath of Shadow Hunter Rala##34731 |goto Frostfire Ridge/0 52.6,40.4
step
...
step
Follow the path |goto Talador/0 59.5,68.9 < 20 |only if walking
...
stickystart "ST14"
step
Cross the bridge |goto Talador/0 59.3,77.6 < 20 |only if walking
Follow the path back |goto Talador/0 60.4,82.1 < 20 |only if walking
Enter the cave |goto Talador/0 61.3,84.2 < 10 |walk
...
step
Continue up the stairs |goto Talador/0 47.1,90.0 < 20 |only if walking
Enter the building |goto Talador/0 45.1,90.5 < 20 |walk
...
step
Follow the path down |goto Talador/0 44.7,87.5 < 20 |only if walking
Go up the hill |goto Talador/0 42.5,80.0 < 20 |only if walking
...
Enter the cave |goto Frostfire Ridge/0 65.8,37.0 < 10 |walk
click Fomic Ore Deposit##226872
collect 20 Fomic Ore##108492 |q 33838/1 |goto Frostfire Ridge/0 66.8,37.4
step
talk Initiate Na'Shra##74977
