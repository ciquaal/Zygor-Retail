...
Follow the path |goto Antoran Wastes/0 68.52,68.81 < 20 |only if ditto
Follow the path |goto Antoran Wastes/0 64.68,65.89 < 15 |only if ditto
...
Follow the path |goto Antoran Wastes/0 62.88,60.46 < 20 |only if ditto
...
step
kill Inquisitor Meto##124592 |goto Invasion Point Meto/0 81.98,46.52
...
Follow the path down |goto Krokuun/0 61.28,44.39 < 15 |only if walking
Follow the path down |goto Krokuun/0 58.57,40.21 < 15 |only if walking
Follow the path down |goto Krokuun/0 59.07,38.23 < 15 |only if walking
Follow the path |goto Krokuun/0 59.55,33.01 < 15 |only if walking
Follow the path up |goto Krokuun/0 60.67,29.92 < 15 |only if walking
Follow the path up |goto Krokuun/0 61.81,29.41 < 15 |only if walking
Follow the path |goto Krokuun/0 62.60,26.62 < 15 |only if walking
Follow the path |goto Krokuun/0 61.58,25.32 < 15 |only if walking
...
Follow the path |goto Antoran Wastes/0 71.17,39.49 < 15 |only if ditto
...
Follow the path |goto Antoran Wastes/0 68.02,33.93 < 15 |only if ditto
Follow the path |goto Antoran Wastes/0 68.29,36.02 < 15 |only if walking
...
Go up the hill |goto Antoran Wastes/0 55.47,51.72 < 15 |only if walking
clicknpc Greater Invasion Point: Occularus##127533 |goto Antoran Wastes/0 55.93,49.67
...
Defeat Occularus |goto Invasion Point Occularus/0 54.78,32.62 |q 49170 |future |next "Invasion_Point_Offensive_Turnin"
step
label invasion-5377
...
Follow the path |goto Antoran Wastes/0 64.35,28.83 < 15 |only if walking
...
Follow the path |goto Invasion Point Vilemus/0 49.44,63.74 < 20 |walk
...
Defeat Pit Lord Vilemus |goto Invasion Point Vilemus/0 16.93,52.53 |q 49168 |future |next "Invasion_Point_Offensive_Turnin"
step
label invasion-5380
Follow the path |goto Eredath/0 43.95,54.55 < 15 |only if walking
Follow the path |goto Eredath/0 44.15,51.17 < 20 |only if walking
...
step
Follow the path |goto Invasion Point Sotanathor/0 26.11,62.05 < 15 |walk
Follow the path |goto Invasion Point Sotanathor/0 32.67,72.88 < 15 |walk
Follow the path |goto Invasion Point Sotanathor/0 41.96,67.61 < 15 |walk
...
Defeat Sotanathor |goto Invasion Point Sotanathor/0 62.46,41.68 |q 49171 |future |next "Invasion_Point_Offensive_Turnin"
stickystart "hazards"
step
label invasion-5367
Go up the hill |goto Eredath/0 43.57,16.84 < 10 |only if walking
Follow the path |goto Eredath/0 41.77,15.92 < 7 |only if walking
Follow the path |goto Eredath/0 41.27,16.49 < 7 |only if walking
Follow the path |goto Eredath/0 39.27,14.47 < 15 |only if walking
clicknpc Invasion Point: Aurinor##125849
Enter the _Invasion Point: Aurinor_ portal |scenariostart |goto Eredath/0 38.78,12.44
...
Destroy #8# Temporal Anomalies |scenariogoal Temporal Anomaly destroyed##2/37095 |goto Invasion Point Aurinor/0 56.27,62.40
|tip Periodically, an image will appear and connect with you through a tether.
|tip Run to the image to avoid damage and gain a stacking damage buff.
step
Kill the Legion Commander |scenariogoal Commander slain##3/37100 |goto Invasion Point Aurinor/0 22.50,51.70 |next "Invasion_Point_Offensive_Turnin"
...
Follow the path |goto Antoran Wastes/0 69.43,69.71 < 20 |only if ditto
Follow the path |goto Antoran Wastes/0 67.17,67.38 < 15 |only if ditto
Follow the path |goto Antoran Wastes/0 71.97,47.26 < 15 |only if walking and knowstaxi("The Veiled Den, Antoran Wastes")
Follow the path |goto Antoran Wastes/0 70.43,47.66 < 15 |only if ditto
Follow the path |goto Antoran Wastes/0 70.74,52.81 < 20 |only if ditto
Follow the path |goto Antoran Wastes/0 68.29,54.23 < 15 |only if ditto
...
Follow the path up |goto Antoran Wastes/0 64.52,55.00 < 15 |only if ditto
Follow the path |goto Antoran Wastes/0 62.88,60.46 < 20 |only if ditto
Follow the path |goto Antoran Wastes/0 63.83,64.27 < 20 |only if ditto
Follow the path |goto Antoran Wastes/0 65.56,67.74 < 20 |only if ditto
clicknpc Invasion Point: Aurinor##125849
Enter the _Invasion Point: Aurinor_ portal |scenariostart |goto Antoran Wastes/0 64.61,69.17
|tip Open your map and look for an invasion icon. They look like green portals.
step
kill Felflame Invader##125755+, Shadowsworn Heretic##125865+
Disrupt the Legion's forces |scenariostage 1 |goto Invasion Point Aurinor/0 56.27,62.40
...
Follow the path |goto Eredath/0 58.84,33.62 < 15 |only if walking
Follow the path |goto Eredath/0 59.96,26.90 < 15 |only if walking
Follow the path |goto Eredath/0 61.09,22.10 < 15 |only if walking
...
Kill #8# Invasive Gazers |scenariogoal Invasive Gazers slain##2/37303 |goto Invasion Point Bonich/0 47.13,56.65
...
step
Defeat the Legion Commander |scenariogoal Ensure Victory##3/37100 |goto Invasion Point Bonich/0 44.45,48.35 |next "Invasion_Point_Offensive_Turnin"
|tip If Baldrazar is present, kill Gripping Shadows and stay behind him unless you're the tank.
|tip If Dread Knight Zak'gal is present, kill Fragment of Argus unless it fixates on you.
|tip If Dreadbringer Valus is present, avoid Slumbering Fog and stay behind him unless you're the tank.
|tip If Fel Lord Kaz'ral is present, destroy Fel Spikes and stay behind him unless you're the tank.
...
Follow the path |goto Antoran Wastes/0 57.27,20.76 < 15 |only if walking
clicknpc Invasion Point: Bonich##126547
...
Follow the path |goto Antoran Wastes/0 60.39,38.83 < 15 |only if walking
Follow the path |goto Antoran Wastes/0 59.90,41.16 < 15 |only if walking
...
Defeat #5# Molten Giants |scenariogoal Molten Giants Defeated##2/37275 |goto Invasion Point Cen'gar/0 59.60,65.38
step
Defeat the Legion commander |scenariogoal Legion Commander Defeated.##3/37100 |goto Invasion Point Cen'gar/0 59.60,65.38 |next "Invasion_Point_Offensive_Turnin"
|tip If Baldrazar is present, kill Gripping Shadows and stay behind him unless you're the tank.
|tip If Dread Knight Zak'gal is present, kill Fragment of Argus unless it fixates on you.
|tip If Dreadbringer Valus is present, avoid Slumbering Fog and stay behind him unless you're the tank.
|tip If Fel Lord Kaz'ral is present, destroy Fel Spikes and stay behind him unless you're the tank.
...
Follow the path |goto Krokuun/0 59.64,67.86 < 7 |only if walking
Follow the path |goto Krokuun/0 59.85,66.81 < 7 |only if walking
Follow the path |goto Krokuun/0 59.72,64.48 < 10 |only if walking
Follow the path |goto Krokuun/0 61.53,62.21 < 10 |only if walking
Go down the stairs |goto Krokuun/0 63.13,62.10 < 15 |only if walking
Follow the path |goto Krokuun/0 64.49,63.29 < 15 |only if walking
Follow the path |goto Krokuun/0 66.10,64.01 < 15 |only if walking
Follow the path |goto Krokuun/0 68.36,67.09 < 15 |only if walking
Follow the path |goto Krokuun/0 70.09,69.21 < 15 |only if walking
Follow the path |goto Krokuun/0 69.15,71.78 < 15 |only if walking
Follow the path |goto Krokuun/0 69.26,76.28 < 15 |only if walking
Follow the path |goto Krokuun/0 68.79,78.55 < 15 |only if walking
Follow the path |goto Krokuun/0 68.21,79.43 < 10 |only if walking
clicknpc Invasion Point: Cen'gar##126120
...
Follow the path up |goto Eredath/0 64.68,42.44 < 15 |only if walking
Follow the path |goto Eredath/0 65.72,43.38 < 10 |only if walking
Follow the path |goto Eredath/0 66.60,42.36 < 10 |only if walking
Follow the path |goto Eredath/0 66.59,41.03 < 10 |only if walking
Follow the path |goto Eredath/0 67.98,39.21 < 15 |only if walking
clicknpc Invasion Point: Naigtal##126593
Enter the _Invasion Point: Naigtal_ portal |scenariostart |goto Eredath/0 70.50,38.47
|tip Open your map and look for an invasion icon. They look like green portals.
step
...
Defeat #5# Hellfire Infernals |scenariogoal Hellfire Infernals defeated##2/37298 |goto Invasion Point Naigtal/0 46.71,51.51
|tip Avoid the Fel Enraged Shamblers.
step
Defeat the Legion Commander |scenariogoal Legion Commander Defeated##3/37100 |goto Invasion Point Naigtal/0 46.71,51.51 |next "Invasion_Point_Offensive_Turnin"
|tip If Fel Lord Kaz'ral is present, destroy Fel Spikes and stay behind him unless you're the tank.
step
label invasion-5374
Follow the path up |goto Antoran Wastes/0 72.28,48.00 < 10 |only if walking and knowstaxi("Light's Purchase, Antoran Wastes")
...
Follow the path |goto Antoran Wastes/0 67.72,28.51 < 15 |only if ditto
Follow the path |goto Antoran Wastes/0 66.00,29.09 < 15 |only if walking
Follow the path |goto Antoran Wastes/0 63.93,28.70 < 20 |only if walking
Follow the path |goto Antoran Wastes/0 61.55,26.74 < 10 |only if walking
Follow the path up |goto Antoran Wastes/0 60.69,26.64 < 10 |only if walking
Follow the path up |goto Antoran Wastes/0 59.74,27.82 < 15 |only if walking
Follow the path |goto Antoran Wastes/0 57.16,28.46 < 15 |only if walking
clicknpc Invasion Point: Naigtal##126593
Enter the _Invasion Point: Naigtal_ portal |scenariostart |goto Antoran Wastes/0 55.33,29.52
|tip Open your map and look for an invasion icon. They look like green portals.
step
kill Chittering Fiend##125921+, Crazed Corruptor##126231+, Vengeful Conqueror##125745+
Defeat the Legion's forces |scenariogoal Defeat Legion forces##1/37078 |goto Invasion Point Naigtal/0 46.71,51.51
...
Follow the path |goto Antoran Wastes/0 69.07,25.29 < 15 |only if walking and knowstaxi("The Veiled Den, Antoran Wastes")
Follow the path |goto Antoran Wastes/0 67.72,28.51 < 15 |only if ditto
Follow the path |goto Antoran Wastes/0 67.99,33.01 < 15 |only if ditto
...
Defeat the Legion forces |scenariostage 2 |goto Invasion Point Sangua/0 53.15,56.70
step
Defeat the Legion Commander |scenariogoal 3/37100 |goto Invasion Point Sangua/0 53.15,56.70 |next "Invasion_Point_Offensive_Turnin"
|tip If Baldrazar is present, kill Gripping Shadows and stay behind him unless you're the tank.
|tip If Dread Knight Zak'gal is present, kill Fragment of Argus unless it fixates on you.
|tip If Dreadbringer Valus is present, avoid Slumbering Fog and stay behind him unless you're the tank.
|tip If Gorgoloth is present, move around if you get the Creeping Doom debuff and stand behind him if you aren't the tank.
...
Follow the path |goto Krokuun/0 71.41,33.77 < 20 |only if walking
clicknpc Invasion Point: Sangua##125863
Enter the _Invasion Point: Sangua_ portal |scenariostart |goto Krokuun/0 73.44,33.85
|tip Open your map and look for an invasion icon. They look like green portals.
step
Follow the path |goto Invasion Point Sangua/0 35.18,72.39 < 15 |walk
kill Legion Blood Drainer##125874+
...
Follow the path |goto Krokuun/0 40.44,67.25 < 15 |only if walking
Follow the path |goto Krokuun/0 41.91,71.72 < 15 |only if walking
Follow the path |goto Krokuun/0 44.30,73.34 < 15 |only if walking
Follow the path |goto Krokuun/0 45.67,75.76 < 15 |only if walking
...
Release #12# Illidari |scenariogoal Illidari released.##2/37095 |goto Invasion Point Val/0 54.80,37.51
|tip They are trapped in ice.
step
Defeat the Legion Commander |scenariogoal Commander slain##3/37100 |goto Invasion Point Val/0 54.80,37.51 |next "Invasion_Point_Offensive_Turnin"
|tip If Baldrazar is present, kill Gripping Shadows and stay behind him unless you're the tank.
|tip If Dread Knight Zak'gal is present, kill Fragment of Argus unless it fixates on you.
|tip If Dreadbringer Valus is present, avoid Slumbering Fog and stay behind him unless you're the tank.
|tip If Fel Lord Kaz'ral is present, destroy Fel Spikes and stay behind him unless you're the tank.
...
Follow the path |goto Antoran Wastes/0 71.54,47.15 < 15 |only if ditto
Follow the path |goto Antoran Wastes/0 70.18,48.67 < 15 |only if ditto
...
Follow the path |goto Antoran Wastes/0 73.28,57.07 < 15 |only if ditto
Follow the path |goto Antoran Wastes/0 73.51,62.27 < 15 |only if ditto
Follow the path |goto Antoran Wastes/0 71.38,73.19 < 15 |only if walking and knowstaxi("Light's Purchase, Antoran Wastes")
Follow the path |goto Antoran Wastes/0 70.19,70.66 < 15 |only if ditto
Follow the path |goto Antoran Wastes/0 71.31,66.25 < 15 |only if ditto
Follow the path |goto Antoran Wastes/0 71.30,62.83 < 15 |only if ditto
Follow the path up |goto Antoran Wastes/0 72.86,63.23 < 15 |only if ditto
clicknpc Invasion Point: Val##126499
Enter the _Invasion Point: Val_ portal |scenariostart |goto Antoran Wastes/0 72.68,65.22
|tip Open your map and look for an invasion icon. They look like green portals.
step
kill Wicked Corruptor##125777+
kill Felrage Marauder##125781+
