...
confirm
step
kill 1 Aku'mai the Devourer##75155 |goto Blackfathom Deeps/2 86.5,86.7
_Phase 1:_
...
step
talk Oralius##45891
accept Infiltrating Shadowforge City##27568 |goto Blackrock Depths 36.7,74.5
...
kill 1 Helix Gearbreaker##47296 |q 27758/1 |goto The Deadmines/1 49.0,87.4 |only if haveq(27758)
_Phase 1:_
...
kill 1 Admiral Ripsnarl##47626 |q 27785/1 |goto The Deadmines/2 63.9,39.5 |only if haveq(27785)
...
step
kill 1 "Captain" Cookie##47739 |goto The Deadmines/2 63.9,39.5 |only if completedq(27790)
kill 1 "Captain" Cookie##47739 |q 27790/1 |goto The Deadmines/2 63.9,39.5 |only if not completedq(27790)
...
step
talk Lieutenant Horatio Laine##46612
turnin The Defias Kingpin##27790 |goto The Deadmines/2 60.9,38.8
only if not completedq(27790)
step
...
step
click the door and go into the next room |goto Dire Maul/2 29.8,42.2
confirm
step
map Dire Maul/4
path follow loose; loop off; ants curved; dist 10
...
kill King Gordok##11501 |q 27125/1 |goto Dire Maul/1 31.8,26.4 |only if haveq(27125)
...
talk Pusillin##14354
Follow the path and talk to Pusillin whenever he stops |goto Dire Maul/5 71.6,46.8 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
talk Pusillin##14354
...
Follow the path and open The Final Chamber door |goto Gnomeregan/4 28.8,45.7
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
...
turnin The G-Team##26942 |goto Gnomeregan/4 34.6,19.9
only if not completedq(26942)
step
...
Follow the path |goto Blackrock Spire/5 53.8,84.8 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
kill Quartermaster Zigris##9736
Defeat Quartermaster Zigris |scenariogoal 1/25780 |goto Blackrock Spire/5 53.8,84.8
step
map Blackrock Spire/5
path follow smart; loop off; ants curved; dist 10
...
confirm
step
kill 1 Lord Vyletongue##12236 |goto Maraudon 37.6,69.5
...
accept No Man Left Behind##30995 |goto Ragefire Chasm/1 68.3,12.8
...
Rescue the first SI:7 Ranger |q 30995/1 |count 1 |goto Ragefire Chasm/1 68.0,60.4
only if not completedq(30995)
step
kill Adarogg##61408
...
Tell it: "It's Safe to come out now." |q 30995/1 |count 2 |goto Ragefire Chasm/1 65.0,70.8
only if not completedq(30995)
step
map Ragefire Chasm/1
path follow loose; loop off; ants curved
...
Rescue the third SI:7 Ranger |q 30995/1 |count 3 |goto Ragefire Chasm/1 60.8,43.2
only if not completedq(30995)
step
map Ragefire Chasm/1
path follow loose; loop off; ants curved
...
Tell it: "It's Safe to come out now." |q 30995/1 |count 4 |goto Ragefire Chasm/1 52.0,26.2
only if not completedq(30995)
step
map Ragefire Chasm/1
path follow loose; loop off; ants curved
...
step
clicknpc SI:7 Ranger##61788
Rescue the last SI:7 Ranger |q 30995/1 |count 5 |goto Ragefire Chasm/1 42.8,66.5
only if not completedq(30995)
step
map Ragefire Chasm/1
path follow loose; loop off; ants curved
...
step
talk High Sorceress Aryna##61823
turnin A New Enemy##30998 |goto Ragefire Chasm/1 33.5,80.6
turnin The Dark Shaman##30996 |goto Ragefire Chasm/1 33.5,80.6
only if not completedq(30998) and not completedq(30996)
step
talk SI:7 Field Commander Dirken##61822
turnin No Man Left Behind##30995 |goto Ragefire Chasm/1 31.7,76.5
only if not completedq(30995)
step
...
confirm
step
kill Mordresh Fire Eye##74347 |goto Razorfen Downs/1 85.2,46.4
...
kill 1 Randolph Moloch##46383 |q 27733/1 |goto The Stockade/1 50.8,19.2 |only if haveq(27733)
...
Follow the path |goto The Stockade/1 25.4,29.7 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
kill 1 Hogger##46254 |goto The Stockade/1 22.1,27.0
...
step
talk Warden Thelwater##46409
turnin The Gnoll King##27739 |goto The Stockade/1 22.1,27.2
only if not completedq(27739)
step
talk Nurse Lillian##46410
...
step
talk Rifle Commander Coe##46417
turnin The Good Ol' Switcheroo##27733 |goto The Stockade/1 50.0,58.5
|tip Located back at the entrance.
only if not completedq(27733)
step
...
Defeat The Unforgiven |scenariogoal 1/24909 |goto Stratholme/1 73.6,20.4
confirm
step
...
Defeat Postmaster Malown |scenariogoal 1/24914 |goto Stratholme/1 69.9,25.3
confirm
step
map Stratholme/1
path follow loose; loop off; ants curved; dist 10
...
Go through this gate |goto Stratholme/2 63.2,65.4 < 5
confirm
step
stickystart "Banshee"
click Gauntlet Gate##3614
Go through this gate |goto Stratholme/2 62.9,57.5 < 5
confirm
step
click Blacksmithing Plans##173232
...
Follow the path back to the entrance |goto The Temple of Atal'Hakkar/1 50.0,15.8 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
You can either run to the beginning of the dungeon to turn in your quests |goto The Temple of Atal'Hakkar/1 50.0,15.8 < 80
Or
You can Right Click the dungeon finder icon on your mini map, teleport out of the dungeon, then teleport back in to the entrance
confirm
step
...
accept The Chamber of Khaz'mul##27672 |goto Uldaman 63.7,72.6
only if not completedq(27672)
step
talk Kand Sandseeker##46247
accept It's What's Inside That Counts##27673 |goto Uldaman 64.0,72.1
...
kill 1 Ironaya##7228 |goto Uldaman/1 45.4,73.7 |only if default
...
kill 1 Ironaya##7228 |q 27672/1 |goto Uldaman/1 45.4,73.7 |only if haveq(27672)
...
step
talk Kand Sandseeker##46247
turnin It's What's Inside That Counts##27673 |goto Uldaman 64.0,72.1
only if not completedq(27673)
step
...
step
kill Skum##3674
Defeat Skum |scenariogoal 24773 |goto Wailing Caverns/1 60.7,72.1
confirm
step
map Wailing Caverns/1
path follow loose; loop off; ants curved
...
Escort and Protect Muyoh until you get to the boss |scenariogoal 2/24776 |goto Wailing Caverns/1 34.5,15.9 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
step
...
Defeat Mutanus the Devourer |scenariogoal 2/34405 |goto Wailing Caverns/1 34.0,15.6
step
...
Defeat Theka the Martyr |scenariogoal 1/24949 |goto Zul'Farrak 54.8,29.3
step
kill Antu'sul##8127
...
confirm
step
click Barrels##2886 |goto Old Hillsbrad Foothills/0 67.9,59.7 < 10 |c |noway
...
Defeat Keli'dan the Breaker |scenariogoal 1/34434 |goto The Blood Furnace/1 59.2,42.5
step
label "felorcblood"
...
step
talk Gunny##54629
turnin Make Them Bleed##29538 |goto The Blood Furnace/1 51.4,90.1
turnin Heart of Rage##29539 |goto The Blood Furnace/1 51.4,90.1
turnin The Breaker##29540 |goto The Blood Furnace/1 51.4,90.1
only if not completedq(29538) or not completedq(29539) or not completedq(29540)
step
...
Create the Fel Ember |q 29649/1 |goto The Shattered Halls/1 31.9,60.6
only if haveq(29649)
step
map The Shattered Halls/1
path follow smart; loop off; ants curved; dist 15
...
step
talk Advance Scout Chadwick##54933
turnin One Last Favor##29652 |goto The Shattered Halls/1 67.2,51.8
turnin How to Save a Life##29649 |goto The Shattered Halls/1 67.2,51.8
turnin O'mrogg's Warcloth##29656 |goto The Shattered Halls/1 67.2,51.8
turnin Turning the Tide##29654 |goto The Shattered Halls/1 67.2,51.8
...
confirm
step
kill Mother Shahraz##22947 |goto Black Temple/4 66.6,37
...
Follow the path, clearing trash as you make your way to the next boss, the Chess event. |goto Karazhan/13 39.9,18.6 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
...
confirm
step
kill 3 Forgotten One##30414+ |q 13187/1 |goto Ahn'kahet: The Old Kingdom/1 32.4,50.1
...
step
talk Reclaimer A'zak##55564
turnin Death to the Traitor King##29807 |goto Azjol-Nerub/1 62.2,48.5
turnin Don't Forget the Eggs!##29808 |goto Azjol-Nerub/1 62.2,48.5
...
Defeat Meathook |scenariogoal 27930 |goto The Culling of Stratholme/1 52.9,62.4
step
map The Culling of Stratholme/1
path follow smart; loop off; ants curved; dist 15
path	45.1,64.9	46.6,58.5	53.1,62.4
...
Defeat Salramm the Fleshcrafter |scenariogoal 27931 |goto The Culling of Stratholme/1 52.9,62.4
step
talk Arthas##26499 |goto The Culling of Stratholme/1 58.8,36.7
...
confirm
step
talk Lady Jaina Proudmoore##36955 |goto Halls of Reflection/1 12.9,23.2
Find Lady Jaina Proudmoore |q 24500/1 |goto Halls of Reflection/1 12.9,23.2 |only if haveq(24500)
...
step
talk Lady Jaina Proudmoore##38160
turnin Wrath of the Lich King##24500 |goto Halls of Reflection/1 75.9,76.4
confirm
only if not completedq(24500)
step
...
turnin The Path to the Citadel##24498 |goto Pit of Saron/0 65.5,54.9
accept Deliverance from the Pit##24710 |goto Pit of Saron/0 65.5,54.9
...
step
label "deathcomplete"
Take the elevator up to the next level |goto Icecrown Citadel/1 39.0,85.5 < 5
confirm
step
...
confirm
step
talk Zafod Boombox##37184 |goto Icecrown Citadel/2 22.6,60.9
...
step
|goto Icecrown Citadel/4 36.6,67.5
...
|confirm
step
_The Lich King_ |goto Icecrown Citadel/7 49.8,50.4
_Phase 1_
...
step
label "beasts25"
_Beasts of Northrend 25 man Heroic_ |goto Trial of the Crusader/1 51.3,52.5
_Phase 1_
kill Gormok the Impaler##34796
...
Click here to advance to _Phase 4_ |confirm
step
kill Mimiron##33350 |goto Ulduar/3 43.6,41.1
...
Watch for _Forgemaster Throngus_ who patrols through the room. Go back into the hallway if you haven't cleared the trash yet. |goto Grim Batol 48.7,47.1
...
Follow the path to Erudax, The Duke of Below. |goto Grim Batol 86.1,57.4 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
...
scenariogoal 1/25090 |goto The Stonecore/1 37.7,44.9
step
map The Stonecore/1
path follow strict;loop off;ants straight
...
|confirm
step
kill Captain Varo'then##55419 |goto Well of Eternity/0 84.7,55.0
_Everyone:_ |grouprole EVERYONE
...
confirm
step
kill Akil'zon##23574 |goto Zul'Aman 35.1,22.9
...
confirm
step
kill Halazzi##23577 |goto Zul'Aman 58.0,23.3
...
|confirm
step
Go back down the hill |goto Zul'Gurub 56.6,63.3 < 5
confirm
step
...
|only if haveq(29172)
step
Follow this path. |goto Zul'Gurub 55.6,27.7 < 5
confirm
step
...
step
talk Overseer Blingbang##53151
turnin Booty Bay's Interests##29154 |goto Zul'Gurub 30.7,47.5
step
talk Bloodslayer Zala##53024
...
click Orb of Culmination##203254 |goto Blackwing Descent/2 47.2,58.0
...
Defeat Commander Durand and High Inquisitor Whitemane |scenariogoal 1/34443 |goto Scarlet Monastery/2 49.2,80.7
step
talk Hooded Crusader##64842
turnin Unto Dust Thou Shalt Return##31516 |goto Scarlet Monastery/2 48.9,78.9
step
...
confirm
step
talk Lady Jaina Proudmoore##72302 |goto Siege of Orgrimmar/4 77.0,29.3
...
Follow the path, clearing trash as you make your way to the first boss, Malkorok. |goto Siege of Orgrimmar/8 44.2,48.0 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
...
Follow the path, clearing trash as you make your way to the next boss, the Paragons of the Klaxxi. |goto Siege of Orgrimmar/10 69.1,38.2 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
The Paragons join the fight in a certain order, as listed. Upon killing a Paragon, the others return to 100% health. |goto Siege of Orgrimmar/10 68.3,35.3
