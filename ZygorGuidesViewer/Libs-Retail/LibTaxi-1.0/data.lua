...
[994]={				-- CHANGED, USED TO BE 905
	['Krokuun']={
		{name="Vindicaar, Krokuun",faction="B",x=42.58,y=22.78,f=1,taxioperator="argusportal",argushub=true, known_fun=function() return ZGV.Parser.ConditionEnv.completedq(47224) end},
	...
	['Eredath']={
		{name="Vindicaar, Eredath",faction="B",x=48.98,y=23.13,f=3,taxioperator="argusportal",argushub=true, known_fun=function() return ZGV.Parser.ConditionEnv.completedq(48081) end}, 
	...
	['Antoran Wastes']={
		{name="Vindicaar, Antoran Wastes",faction="B",x=32.32,y=56.57,f=5,taxioperator="argusportal",argushub=true, known_fun=function() return ZGV.Parser.ConditionEnv.completedq(48199) end}, 
