...
function GearFinder:IsValidDungeon(dungeon, instanceId, diff)
	...
	if ZGV.IsRetail and dungeon.min_ilevel and dungeon.min_ilevel > ItemScore.playeritemlvl then return false, true, ident, maxScaleLevel, mythic, "need higher item level "..dungeon.min_ilevel end
